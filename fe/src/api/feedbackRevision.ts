...
export const createRevisionRequest = async (data: {
    ...
    return await api.post('/api/feedback-revision/request', data);
};
...
export const getSellerRequests = async (params?: {
    ...
    return await api.get('/api/feedback-revision/seller/requests', { params });
};
...
export const cancelRevisionRequest = async (requestId: string) => {
    return await api.delete(`/api/feedback-revision/request/${requestId}`);
};
...
export const getBuyerRequests = async (params?: {
    ...
    return await api.get('/api/feedback-revision/buyer/requests', { params });
};
...
export const respondToRequest = async (requestId: string, data: {
    ...
    return await api.post(`/api/feedback-revision/request/${requestId}/respond`, data);
};
...
export const applyRevision = async (requestId: string, data: {
    ...
    return await api.post(`/api/feedback-revision/request/${requestId}/apply`, data);
};
...
export const getAdminRequests = async (params?: {
    ...
    return await api.get('/api/feedback-revision/admin/requests', { params });
};
...
export const getFlaggedRequests = async (params?: {
    ...
    return await api.get('/api/feedback-revision/admin/flagged', { params });
};
...
export const adminReviewRequest = async (requestId: string, data: {
    ...
    return await api.post(`/api/feedback-revision/admin/${requestId}/review`, data);
};
...
export const validateMessage = async (message: string) => {
    return await api.post('/api/feedback-revision/validate-message', { message });
};
